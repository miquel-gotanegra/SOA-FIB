...
SYSOBJ = interrupt.o entry.o sys_call_table.o io.o sched.o sys.o mm.o devices.o utils.o hardware.o list.o p_stats.o kernel-utils.o piper.o
...
sched.o:sched.c $(INCLUDEDIR)/sched.h $(INCLUDEDIR)/piper.h
...
piper.o:piper.c $(INCLUDEDIR)/piper.h
